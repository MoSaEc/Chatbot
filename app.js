...
const flowPasto = addKeyword(['pasto', '1', 'Pasto Sintetico', 'Sintetico', 'Pasto','https://www.facebook.com/share/p/NqG4nw2RmTjHUYzw/?mibextid=qi2Omg'])
.addAnswer(
    [
    ...
    'ingresa *Listo* para finalizar',
    ],
    { media: 'https://i.ibb.co/PgRhyxd/ps1.jpg'},
    [flowSecundario]
)
.addAnswer(
    ['Cualquier detella estamos a tu servicio '
],
{ media: 'https://i.ibb.co/ZYL02WK/ps.jpg'}
)

const flowLambrin = addKeyword(['L','lambrin','Lambrin','2','tutorial', 'tuto','https://www.facebook.com/share/v/2FMHtzLqdQCfKa3k/?mibextid=qi2Omg'])
.addAnswer(
    [
...
const flowMarmol = addKeyword(['Marmol', 'PVC', 'Placas','https://www.facebook.com/share/v/C9BWRRZtSMREt1sk/?mibextid=qi2Omg'])
.addAnswer(
    [
...
const flowBoox = addKeyword(['4','Follaje', 'Artificial', 'Premium','https://www.facebook.com/share/p/ut9jEgpUcJYTbU4x/?mibextid=qi2Omg'])
.addAnswer(
